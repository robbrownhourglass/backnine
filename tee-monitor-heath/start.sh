...
PORT="$("$PYTHON_BIN" -c 'import config; print(config.DASHBOARD_PORT)' 2>/dev/null || echo 5050)"
LOG_DIR="$DIR/logs"
mkdir -p "$LOG_DIR"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Tee Monitor — Starting"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""

# 1. Start scraper
echo "▶ Starting scraper..."
"$PYTHON_BIN" -u scraper.py > "$LOG_DIR/scraper.log" 2>&1 &
SCRAPER_PID=$!
...
"$PYTHON_BIN" -u app.py > "$LOG_DIR/dashboard.log" 2>&1 &
FLASK_PID=$!
